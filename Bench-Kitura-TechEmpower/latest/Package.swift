...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/IBM-Swift/Swift-Kuery-PostgreSQL.git", .branch("issue_async_results")),
        .package(url: "https://github.com/IBM-Swift/Swift-Kuery-ORM.git", .branch("issue_adopt_async_results")),
